...
function App() {
  ...
  const [stage, setStage] = useState('drug-selection'); // 'drug-selection' | 'file-upload' | 'results'
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      // Send drugs as comma-separated query parameter
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <p className="text-indigo-100 text-sm">CPIC-Aligned Analysis</p>
              <p className="text-indigo-200 text-xs mt-1">v2.0 • Dual-Layer LLM Explanations</p>
            </div>
          </div>
        </div>
      </header>
